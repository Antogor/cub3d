...
./libft/ft_strnstr.c ./libft/ft_strtrim.c ./libft/ft_split.c ./libft/ft_isalpha.c ./libft/ft_memcpy.c ./libft/ft_bzero.c
...
./libft/ft_strnstr.o ./libft/ft_strtrim.o ./libft/ft_split.o ./libft/ft_isalpha.o ./libft/ft_memcpy.o ./libft/ft_bzero.o
