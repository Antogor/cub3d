...
FUN = cub3d.c create_trgb.c paint.c ft_map.c movement.c raycasting.c check_data.c #ft_keys.c

OBJ = cub3d.o create_trgb.o paint.o ft_map.o movement.o raycasting.o check_data.o #ft_keys.o
