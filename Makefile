...
MINILIBX = -lmlx -lXext -lX11 -lm #-lmlx -framework OpenGl -framework AppKit #-Imlx -Iinc -lmlx -framework OpenGL -framework AppKit #-lmlx -lXext -lX11 -lm \
#-L ./minilibx_opengl_20191021 -l mlx -framework OpenGL -framework AppKit

FUN = cub3d.c create_trgb.c paint.c ft_map.c movement.c raycasting.c check_data.c check_map.c extract_color.c ft_keys.c #extract_textures.c

OBJ = cub3d.o create_trgb.o paint.o ft_map.o movement.o raycasting.o check_data.o check_map.o extract_color.o ft_keys.o #extract_textures.o
