...
OBJ = cub3d.o create_trgb.o paint.o ft_map.o movement.o raycasting.o check_map.o #ft_keys.o
...
./libft/ft_strnstr.c ./libft/ft_strtrim.c
...
./libft/ft_strnstr.o ./libft/ft_strtrim.o
